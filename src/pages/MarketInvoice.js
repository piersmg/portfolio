...
const Body = () => {
    return (
        <div className="flex flex-col mx-auto items-center">
            ...
            <h2 className="text-2xl mb-4 mt-8">Homepage</h2>
            ...
            <div className="flex flex-col md:flex-row items-start">
                <img src="/images/mi/mi-old.jpg" alt="MarketFinance old homepage" />
                <img src="/images/mi/mi-new.jpg" alt="MarketFinance new homepage" />
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start">
                <img src="/images/mi/mi-sol-pen.jpg" alt="MarketFinance solutions page pen wireframe" />
                <img src="/images/mi/mi-sol-pen2.jpg" alt="MarketFinance solutions page pen wireframe" />
                <img src="/images/mi/mi-sol-wireframe.jpg" alt="MarketFinance solutions page digital wireframe 1" />
            </div>
            ...
            <img src="images/mi/mi-sol-wireframe2.jpg" alt="MarketFinance solutions page digital wireframe 2" />
            ...
            <div className="flex flex-col md:flex-row items-start">
                <img src="/images/mi/mi-sol-wireframe3.jpg" alt="MarketFinance solutions page digital wireframe 3" />
                <img src="/images/mi/mi-sol-menu.jpg" alt="MarketFinance solutions page digital wireframe for menu" />
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start">
                <img src="/images/mi/mi-sol-final1.png" alt="MarketFinance solutions page final" />
                <img src="/images/mi/mi-sol-final2.png" alt="MarketFinance solutions page final" />
            </div>
            ...
            <div className="grid grid-flow-row gap-4 md:grid-cols-2 grid-cols-1">
                <div className="flex flex-col">
                    <img className="!mb-2" src="images/mi/guidelines1.jpg" alt="MarketFinance brand colour guidelines" />
                    <p className="text-sm">Laying out the brand colours, any variations, and use cases for the website.</p>
                </div>
                <div className="flex flex-col">
                    <img className="!mb-2" src="images/mi/guidelines2.jpg" alt="MarketFinance layout guidelines" />
                ...
                <div className="flex flex-col">
                    <img className="!mb-2" src="images/mi/guidelines3.jpg" alt="MarketFinance menu guidelines" />
                ...
                <div className="flex flex-col">
                    <img className="!mb-2" src="images/mi/guidelines6.jpg" alt="MarketFinance overall guidelines" />
