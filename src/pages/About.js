    ...
    return (
        <div className="h-[calc(100vh_-_8rem)]">
            <Content 
                ...
                body={[<div className="flex flex-col justify-center items-center h-full">
                    <p className="mb-4 max-w-3xl">I’m a website developer and designer based in London, currently working at Mews, a hospitality tech company.
                    ...
                    <p className="mb-4 max-w-3xl">I have worked on many different types of sites: from templated site-builder sites, e.g. Wordpress or Wix, for the client that wants a website they can manage 
