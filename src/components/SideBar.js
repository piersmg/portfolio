...
const SideBar = () => {
	return (
		<div className="fixed hidden md:flex top-0 md:-left-8 lg:left-0 h-screen w-16 m-0
			...
			<div id="darkLightSwitch" className="absolute bottom-8 md:left-16 lg:left-8 text-primary dark:text-white hover:text-secondary dark:hover:text-secondary cursor-pointer transition-transform">
